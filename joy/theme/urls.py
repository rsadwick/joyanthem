...
from joy.theme.views import ListView, SongList, ArtistDetail, get_captions, SongOfTheDayList, AllArtistList, browse, SongDetail


urlpatterns = patterns("",
   url(r'^newest/$', SongList.as_view()),
   url(r'^artist/(?P<slug>[-_\w]+)/$', ArtistDetail.as_view(), name='artist_detail'),
   url(r'^song/(?P<slug>[-_\w]+)/$', SongDetail.as_view(), name='song_detail'),
